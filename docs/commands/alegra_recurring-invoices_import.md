---
title: alegra recurring-invoices import
---

## alegra recurring-invoices import

Bulk-create recurring-invoices from a CSV file

### Synopsis

Create one recurring-invoice per CSV row.
...
```
alegra recurring-invoices import [flags]
```

### Examples

```
  alegra recurring-invoices import --file rows.csv
