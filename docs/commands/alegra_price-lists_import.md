---
title: alegra price-lists import
---

## alegra price-lists import

Bulk-create price-lists from a CSV file

### Synopsis

Create one price-list per CSV row.
...
```
alegra price-lists import [flags]
```

### Examples

```
  alegra price-lists import --file rows.csv
