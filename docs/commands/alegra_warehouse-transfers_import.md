---
title: alegra warehouse-transfers import
---

## alegra warehouse-transfers import

Bulk-create warehouse-transfers from a CSV file

### Synopsis

Create one warehouse-transfer per CSV row.
...
```
alegra warehouse-transfers import [flags]
```

### Examples

```
  alegra warehouse-transfers import --file rows.csv
