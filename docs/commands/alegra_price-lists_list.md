---
title: alegra price-lists list
---

## alegra price-lists list

List price-lists

```
alegra price-lists list [flags]
```
...
```
  alegra price-lists list
  alegra price-lists list --limit 30 --all -o json
  alegra price-lists list --count
  alegra price-lists list --param <api_param>=<value>
```
