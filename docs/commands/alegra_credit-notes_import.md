---
title: alegra credit-notes import
---

## alegra credit-notes import

Bulk-create credit-notes from a CSV file

### Synopsis

Create one credit-note per CSV row.
...
```
alegra credit-notes import [flags]
```

### Examples

```
  alegra credit-notes import --file rows.csv
