---
title: alegra warehouses create
---

## alegra warehouses create
...
```
alegra warehouses create [flags]
```

### Examples

```
  alegra warehouses create -f warehous.json
  alegra warehouses create --set name="Example"
  echo '{...}' | alegra warehouses create -f -
```
