---
title: alegra item-categories import
---

## alegra item-categories import

Bulk-create item-categories from a CSV file

### Synopsis

Create one item-category per CSV row.
...
```
alegra item-categories import [flags]
```

### Examples

```
  alegra item-categories import --file rows.csv
