---
title: alegra transportation-receipts import
---

## alegra transportation-receipts import

Bulk-create transportation-receipts from a CSV file

### Synopsis

Create one transportation-receipt per CSV row.
...
```
alegra transportation-receipts import [flags]
```

### Examples

```
  alegra transportation-receipts import --file rows.csv
