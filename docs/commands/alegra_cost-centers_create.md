---
title: alegra cost-centers create
---

## alegra cost-centers create
...
```
alegra cost-centers create [flags]
```

### Examples

```
  alegra cost-centers create -f cost-center.json
  alegra cost-centers create --set name="Example"
  echo '{...}' | alegra cost-centers create -f -
```
