---
title: alegra sellers create
---

## alegra sellers create
...
```
alegra sellers create [flags]
```

### Examples

```
  alegra sellers create -f seller.json
  alegra sellers create --set name="Example"
  echo '{...}' | alegra sellers create -f -
```
