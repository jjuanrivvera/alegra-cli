---
title: alegra sellers import
---

## alegra sellers import

Bulk-create sellers from a CSV file

### Synopsis

Create one seller per CSV row.
...
```
alegra sellers import [flags]
```

### Examples

```
  alegra sellers import --file rows.csv
