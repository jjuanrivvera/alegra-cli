---
title: alegra journals import
---

## alegra journals import

Bulk-create journals from a CSV file

### Synopsis

Create one journal per CSV row.
...
```
alegra journals import [flags]
```

### Examples

```
  alegra journals import --file rows.csv
