---
title: alegra cost-centers import
---

## alegra cost-centers import

Bulk-create cost-centers from a CSV file

### Synopsis

Create one cost-center per CSV row.
...
```
alegra cost-centers import [flags]
```

### Examples

```
  alegra cost-centers import --file rows.csv
