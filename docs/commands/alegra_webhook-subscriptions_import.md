---
title: alegra webhook-subscriptions import
---

## alegra webhook-subscriptions import

Bulk-create webhook-subscriptions from a CSV file

### Synopsis

Create one webhook-subscription per CSV row.
...
```
alegra webhook-subscriptions import [flags]
```

### Examples

```
  alegra webhook-subscriptions import --file rows.csv
