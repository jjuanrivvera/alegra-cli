---
title: alegra reconciliations create
---

## alegra reconciliations create
...
```
alegra reconciliations create [flags]
```

### Examples

```
  alegra reconciliations create -f reconciliation.json
  alegra reconciliations create --set name="Example"
  echo '{...}' | alegra reconciliations create -f -
```
