---
title: alegra estimates import
---

## alegra estimates import

Bulk-create estimates from a CSV file

### Synopsis

Create one estimate per CSV row.
...
```
alegra estimates import [flags]
```

### Examples

```
  alegra estimates import --file rows.csv
