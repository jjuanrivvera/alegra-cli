---
title: alegra global-invoices import
---

## alegra global-invoices import

Bulk-create global-invoices from a CSV file

### Synopsis

Create one global-invoice per CSV row.
...
```
alegra global-invoices import [flags]
```

### Examples

```
  alegra global-invoices import --file rows.csv
