---
title: alegra inventory-adjustment-numerations update
---

## alegra inventory-adjustment-numerations update

Update a inventory-adjustment-numeration by ID

```
alegra inventory-adjustment-numerations update <id> [flags]
```
