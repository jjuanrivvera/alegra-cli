---
title: alegra transportation-receipts update
---

## alegra transportation-receipts update

Update a transportation-receipt by ID

```
alegra transportation-receipts update <id> [flags]
```
