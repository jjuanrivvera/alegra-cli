---
title: alegra purchase-orders import
---

## alegra purchase-orders import

Bulk-create purchase-orders from a CSV file

### Synopsis

Create one purchase-order per CSV row.
...
```
alegra purchase-orders import [flags]
```

### Examples

```
  alegra purchase-orders import --file rows.csv
