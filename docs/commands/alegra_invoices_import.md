---
title: alegra invoices import
---

## alegra invoices import

Bulk-create invoices from a CSV file

### Synopsis

Create one invoice per CSV row.
...
```
alegra invoices import [flags]
```

### Examples

```
  alegra invoices import --file rows.csv
