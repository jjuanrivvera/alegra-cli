---
title: alegra custom-fields import
---

## alegra custom-fields import

Bulk-create custom-fields from a CSV file

### Synopsis

Create one custom-field per CSV row.
...
```
alegra custom-fields import [flags]
```

### Examples

```
  alegra custom-fields import --file rows.csv
