---
title: alegra payments import
---

## alegra payments import

Bulk-create payments from a CSV file

### Synopsis

Create one payment per CSV row.
...
```
alegra payments import [flags]
```

### Examples

```
  alegra payments import --file rows.csv
