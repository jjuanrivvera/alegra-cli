---
title: alegra additional-charges import
---

## alegra additional-charges import

Bulk-create additional-charges from a CSV file

### Synopsis

Create one additional-charge per CSV row.
...
```
alegra additional-charges import [flags]
```

### Examples

```
  alegra additional-charges import --file rows.csv
