---
title: alegra retentions import
---

## alegra retentions import

Bulk-create retentions from a CSV file

### Synopsis

Create one retention per CSV row.
...
```
alegra retentions import [flags]
```

### Examples

```
  alegra retentions import --file rows.csv
