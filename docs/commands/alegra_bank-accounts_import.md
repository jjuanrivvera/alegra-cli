---
title: alegra bank-accounts import
---

## alegra bank-accounts import

Bulk-create bank-accounts from a CSV file

### Synopsis

Create one bank-account per CSV row.
...
```
alegra bank-accounts import [flags]
```

### Examples

```
  alegra bank-accounts import --file rows.csv
