---
title: alegra inventory-adjustments import
---

## alegra inventory-adjustments import

Bulk-create inventory-adjustments from a CSV file

### Synopsis

Create one inventory-adjustment per CSV row.
...
```
alegra inventory-adjustments import [flags]
```

### Examples

```
  alegra inventory-adjustments import --file rows.csv
