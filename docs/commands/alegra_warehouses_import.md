---
title: alegra warehouses import
---

## alegra warehouses import

Bulk-create warehouses from a CSV file

### Synopsis

Create one warehous per CSV row.
...
```
alegra warehouses import [flags]
```

### Examples

```
  alegra warehouses import --file rows.csv
