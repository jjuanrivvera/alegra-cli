---
title: alegra debit-notes import
---

## alegra debit-notes import

Bulk-create debit-notes from a CSV file

### Synopsis

Create one debit-note per CSV row.
...
```
alegra debit-notes import [flags]
```

### Examples

```
  alegra debit-notes import --file rows.csv
