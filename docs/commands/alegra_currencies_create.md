---
title: alegra currencies create
---

## alegra currencies create
...
```
alegra currencies create [flags]
```

### Examples

```
  alegra currencies create -f currency.json
  alegra currencies create --set name="Example"
  echo '{...}' | alegra currencies create -f -
```
