---
title: alegra categories import
---

## alegra categories import

Bulk-create categories from a CSV file

### Synopsis

Create one category per CSV row.
...
```
alegra categories import [flags]
```

### Examples

```
  alegra categories import --file rows.csv
