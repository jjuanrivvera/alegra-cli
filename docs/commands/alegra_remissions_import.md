---
title: alegra remissions import
---

## alegra remissions import

Bulk-create remissions from a CSV file

### Synopsis

Create one remission per CSV row.
...
```
alegra remissions import [flags]
```

### Examples

```
  alegra remissions import --file rows.csv
