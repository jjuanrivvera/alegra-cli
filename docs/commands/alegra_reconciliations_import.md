---
title: alegra reconciliations import
---

## alegra reconciliations import

Bulk-create reconciliations from a CSV file

### Synopsis

Create one reconciliation per CSV row.
...
```
alegra reconciliations import [flags]
```

### Examples

```
  alegra reconciliations import --file rows.csv
