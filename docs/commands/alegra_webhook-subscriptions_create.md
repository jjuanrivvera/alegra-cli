---
title: alegra webhook-subscriptions create
---

## alegra webhook-subscriptions create
...
```
alegra webhook-subscriptions create [flags]
```

### Examples

```
  alegra webhook-subscriptions create -f webhook-subscription.json
  alegra webhook-subscriptions create --set name="Example"
  echo '{...}' | alegra webhook-subscriptions create -f -
```
