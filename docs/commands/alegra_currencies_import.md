---
title: alegra currencies import
---

## alegra currencies import

Bulk-create currencies from a CSV file

### Synopsis

Create one currency per CSV row.
...
```
alegra currencies import [flags]
```

### Examples

```
  alegra currencies import --file rows.csv
