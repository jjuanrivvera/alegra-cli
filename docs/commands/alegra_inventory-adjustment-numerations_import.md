---
title: alegra inventory-adjustment-numerations import
---

## alegra inventory-adjustment-numerations import

Bulk-create inventory-adjustment-numerations from a CSV file

### Synopsis

Create one inventory-adjustment-numeration per CSV row.
...
```
alegra inventory-adjustment-numerations import [flags]
```

### Examples

```
  alegra inventory-adjustment-numerations import --file rows.csv
