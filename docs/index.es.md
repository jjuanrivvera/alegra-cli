...
perfiles con nombre, un modo dry-run y un [servidor MCP de Alegra](user-guide/mcp.md)
integrado.
...
- Agentes de IA: [Servidor MCP de Alegra](user-guide/mcp.md) · [Alegra MCP vs. el servidor oficial](reference/vs-official-mcp.md) · [Skill para agentes](user-guide/agent-skill.md) · [Seguridad para agentes](user-guide/agent-safety.md)
